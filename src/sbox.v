...
//               Implements the full 256-entry lookup table using a case
//               statement. Input is an 8-bit byte; output is the substituted
//               byte according to the AES specification.
// =============================================================================
