// =============================================================================
// sbox.v  –  AES-128 Forward S-box (FIPS-197, Fig. 7)
//
// FIX: Replaced reg-array + initial block with a pure combinational always/case.
//      The initial block is simulation-only and NOT synthesizable in the
//      OpenLane ASIC flow (Yosys).  A case statement is inferred as a
//      256-to-8 ROM of standard cells and is fully supported.
//
// Also removed `timescale (simulation-only directive, rejected by OpenLane).
// =============================================================================
